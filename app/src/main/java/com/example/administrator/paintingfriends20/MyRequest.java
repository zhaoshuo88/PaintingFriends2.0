...
public class MyRequest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_myrequest, container, false);

        findView();
        requestAdapter = new MyRequestAdapter(getActivity(),lRequest);
    ...
    private void getData(){
        for (int i = 0;i < 10; i++){
            ...
            lRequest.add(new MyRequestDomain((long)rid,name,redetail,rdate));
